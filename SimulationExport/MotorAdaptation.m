function [ Fs,Fg,Fp,t] = MotorAdaptation(excitation,amp,freq,xps,adaptation )
...
for i=1:numel(t)
    ...
    [xm_out,xs_out,Fgt,Fst,Fpt] = MotorUpdate( Cl,S,B,ks,kp,kg,dt,xmt,xpt,xst );
